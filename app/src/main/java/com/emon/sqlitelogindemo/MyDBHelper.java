...
public class MyDBHelper extends SQLiteOpenHelper {
    ...
    private static final String EMP_LIST = "CREATE TABLE emp_details ( _id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR(255), mobile VARCHAR(32), email VARCHAR(55));";
    ...
    public long addEmpList(String name, String mobile, String email) {

        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(EMP_LIST, name);
